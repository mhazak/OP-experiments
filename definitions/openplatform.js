...
FUNC.profile = function(user, callback) {
	...
	meta.background_scheme = user.background_scheme;
	...
	if (user.sa) {
		let control_panel = { 
			id: '_admin', icon: 'cog', 
			menu: [
				{ name: 'Dashboard', common: { page: 'dashboard' }, icon: "fa fa-dashboard" },
				{ name: 'Reports', common: { page: 'reports' }, icon: "fa fa-bug" },
				{ name: 'Logs', common: { page: 'logs' }, icon: "fas fa-history" },
				{ name: 'Users', common: { page: 'users' }, icon: "fa fa-users" },
				{ name: 'Groups', common: { page: 'groups' }, icon: "fa fa-folder" },
				{ name: 'Roles', common: { page: 'roles' }, icon: "fa fa-key" },
				{ name: 'Marketplace', common: { page: 'marketplace' }, icon: "fa fa-shopping-bag" },
				{ name: 'Applications', common: { page: 'apps' }, icon: "fa fa-rocket" },
				{ name: 'OAuth 2.0', common: { page: 'oauth' }, icon: "fa fa-key" },
				{ name: 'Documentation', common: { page: 'wiki' }, icon: "far fa-life-ring" },
				{ name: 'LDAP', common: { page: 'ldap' }, icon: "fas fa-coins" },
				{ name: 'Settings', common: { page: 'settings' }, icon: "fa fa-sliders-h" },
			],
			 
			title: TRANSLATOR(user.language, '@(Control panel)'), 
			name: 'Admin', 
			online: true, 
			internal: true, 
			linker: '_admin', 
